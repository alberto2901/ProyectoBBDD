        ...
        Integer opcion = null;
            ...
            while (true) {
                try {
                    ...
                    System.out.println("  1. Visualizar tabla (10 siguientes, 10 anteriores)");
                    System.out.println("  2. Buscar datos de empleados.");
                    System.out.println("  3. Insertar datos de un empleado.");
                    System.out.println("  4. Actualizar datos de un empleado.");
                    System.out.println("  5. Eliminar datos de un empleado.\n");
        ...
        public static void visualizarTabla(){
            ...
            while (true) {
                try {
                    ...
                    for (Cliente cliente : clientesdao.listar(start,fin)){
                        System.out.println(cliente);
                    }
                    clientesdao.listar(start,fin);
        ...
        public static void borrarCliente() {
            ...
            if (cliente != null) {
                    ...
                    if (resp.equalsIgnoreCase("y")) {
                        clientesdao.delete(cliente.getId());
